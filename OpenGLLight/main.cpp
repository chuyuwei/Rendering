...
int main()
{
	...
	// -------------------------
	Shader shader("vertfrag/7.bloom.vert", "vertfrag/7.bloom.frag");
	Shader shaderLight("vertfrag/7.bloom.vert", "vertfrag/7.light_box.frag");
	Shader shaderBlur("vertfrag/7.blur.vert", "vertfrag/7.blur.frag");
	Shader shaderBloomFinal("vertfrag/7.bloom_final.vert", "vertfrag/7.bloom_final.frag");
